...
from one, read [`references/gfm-advanced.md`](references/gfm-advanced.md) for the syntax and
the gotchas. Use them only where they add genuine value.

---

**Credit:** Adapted verbatim from [Nate Berkopec's dotfiles](https://github.com/nateberkopec/dotfiles/blob/main/files/home/.claude/skills/github-readme/SKILL.md).
