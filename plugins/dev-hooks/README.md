...
- `prompt-log.sh` is one of two **UserPromptSubmit** hooks (`intent-check-reminder.sh` is the
  other; both share the `reminder_prompt_init` lib preamble). It appends one JSON line per prompt
