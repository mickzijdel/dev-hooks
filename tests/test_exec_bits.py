...
working-tree permissions — and with core.fileMode=false (as in this repo) a local
chmod +x never reaches git. A shebang script tracked at 100644 therefore dies with
exit 126 "Permission denied" on every other machine. This mirrors the hk
...
def test_shebang_scripts_are_executable_in_git_index():
    ...
    assert modes.get("plugins/dev-hooks/hooks/scripts/verify-work.sh") == "100755"
